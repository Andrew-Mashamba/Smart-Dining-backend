<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <form action="{{ route('proposals.store') }}" method="POST" class="space-y-6 bg-white rounded-xl border border-gray-200 p-6">
                @csrf
                ...
                <div>
                    ...
                    <textarea name="summary" id="summary" rows="2" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-gray-900 focus:ring-gray-900">{{ old('summary') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="body" id="body" rows="6" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-gray-900 focus:ring-gray-900">{{ old('body') }}</textarea>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="currency" id="currency" value="{{ old('currency', 'ZAR') }}" maxlength="3"
                               class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-gray-900 focus:ring-gray-900">
                ...
                <div class="flex justify-end gap-2">
                    <a href="{{ route('proposals.index') }}" class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50">Cancel</a>
                    <button type="submit" class="px-4 py-2 bg-gray-900 text-white rounded-lg hover:bg-gray-800">Create Proposal</button>
                </div>
            </form>
        </div>
    </div>
